...
//   suspects$ = this.suspectsSubject.asObservable();

//   private selectedSuspectSubject = new BehaviorSubject<Suspect | null>(null);
//   selectedSuspect$ = this.selectedSuspectSubject.asObservable();

//   constructor(private http: HttpClient) {}

//   loadSuspects() {
//     this.http.get<Suspect[]>('assets/data/suspects.json')
//       .subscribe(data => this.suspectsSubject.next(data));
//   }
...
//   filterSuspects(search: string) {
//     const current = this.suspectsSubject.getValue();
