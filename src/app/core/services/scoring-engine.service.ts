...
//     suspect.history.forEach(h => {

//       const arrival = new Date(h.arrivalTime);
//       const departure = new Date(h.departureTime);
...
//       else if (distance <= 10) score += 35;    // near crime location
...
//     if (suspect.riskLevel === 'HIGH') score += 20;
